    ...
    children: [
      {
        ...
        name: 'Documentation',
        meta: { title: '文档', icon: 'documentation', affix: true, roles: ['admin'] }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'Guide',
        meta: { title: '引导页', icon: 'guide', noCache: true, roles: ['admin'] }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'Theme',
        meta: { title: '换肤', icon: 'theme', roles: ['admin'] }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '外链', icon: 'link', roles: ['admin'] }
      }
    ]
  },
